...
================================================== -->
  <meta charset="utf-8">
  <title>Home | GIITS Collage</title>

  <?php include'./includes/head-session.php' ?>
        ...
        <div class="container h-100">
          <div class="row align-items-center h-100">
              <div class="col-md-12 text-center">
                <h2 class="slide-title" data-animation-in="slideInLeft">13 Years of excellence in</h2>
                <h3 class="slide-sub-title" data-animation-in="slideInRight">Making Professionals</h3>
...
<div class="banner-carousel banner-carousel-1 mb-0">
  <div class="banner-carousel-item" style="background-image:url(./images/banner/founder.jpg)">
  </div>
</div>
...
<section id="news" class="news">
  <div class="container">
    <div class="row text-center">
        <div class="col-12">
          <h2 class="section-title">Work of Excellence</h2>
          <h3 class="section-sub-title">Industrial Visits</h3>
        </div>
    </div>
    <!--/ Title row end -->
